...
public class TextureUtils {
	...
	/**
	 * Simply because I only need one instance of this, and I'd like to access it
	 * like this because I'm lazy.
	 * 
	 ...
	 */
	  public void initialUpload() {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, textureID);
         ...
         GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, MiniMap.width, MiniMap.width, 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, (ByteBuffer)null);
	 ...
	 /**
	  * WARNING! ONLY CALL FROM render(); in the Widget! or baaaaaad things
	 ...
	 public void updateTexture(ByteBuffer texture) {
		 try {
		 GL11.glBindTexture(GL11.GL_TEXTURE_2D, textureID);
		 GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, MiniMap.width, MiniMap.width, 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, texture);
